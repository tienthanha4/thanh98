...
function deleteProductById(baseUrl, id) {
	...
	jQuery.ajax({
		url: baseUrl + "/ajax/product/delete", //->action
		type: "post",
...
function deleteCategoryById(baseUrl, id) {
	// javascript object.  data la du lieu ma day len action cua controller
	alert(id);
	let data = {
		id:id, // lay theo id
	...
	jQuery.ajax({
		url: baseUrl + "/ajax/category/delete", //->action
		type: "post",
		contentType: "application/json",
		data: JSON.stringify(data),
		dataType: "json", // kieu du lieu tra ve tu controller la json
