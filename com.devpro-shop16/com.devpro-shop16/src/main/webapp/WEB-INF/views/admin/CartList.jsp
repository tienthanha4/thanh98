		...
		<div class="bottom_content">
			...
			<div class="container-fluid">
				...
				<p>
					...
					<sf:form method="get"
						action="${pageContext.request.contextPath}/Admin/cart/list"
						...
						<table class="table">
							...
							<tbody>
								<c:forEach var="saleOrderProduct" items="${saleOrderProductwithPaging.data}">
									<tr>
										<th scope="row">${saleOrderProduct.id}</th>
										<td>${saleOrderProduct.saleOrder.customerName}</td>
										<td>${saleOrderProduct.saleOrderProducts.title}</td>
										<td>${saleOrderProduct.quality}</td>
										<td>${saleOrderProduct.saleOrder.total}</td>
										<%-- <td>
									<img alt="" src="${pageContext.request.contextPath}/upload/${products.avatar}">
									</td> --%>
										<td><a href="">
												<button type="button"
													onclick="deleteCategoryById('${pageContext.request.contextPath}',${saleOrderProduct.id})"
													class="
...
<script type="text/javascript">
			$( document ).ready(function() {
				$("#paging").pagination({ 
					currentPage: ${saleOrderProductwithPaging.currentPage},
			        items: ${saleOrderProductwithPaging.totalItems},
			        itemsOnPage: 5,
			        cssStyle: 'dark-theme',
