						...
						<ul>
							...
							<li class="nav-item dropdown"><a
								...
								<c:forEach items="${categories}" var="category">
									<a class="dropdown-item" href="${pageContext.request.contextPath}/category/${category.seo}">${category.name}</a> 
								</c:forEach>
								</div></li>
							<li class="nav-item dropdown"><a
								class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"
		...
		<main>
			<div class="container all">
				<div class="container">
					<div class="container">
						<div class="content-1">
							<h2 class="page-title" id="soluong">
								${totalItems} <i class="fa fa-angle-right"></i>
							</h2>
							<h2 class="page-title">
												...
												<div class="card" style=>
													...
													<div class="card-body">
														...
														<li class="clearfix list-inline" style="font-size: 14px;"><a
															href="#">Chương 1</a><i
															class="float-right font-weight-normal">25phut truoc</i></li>
															<button id ="scroll" onclick="ls('${pageContext.request.contextPath}',${product.id},1)">test</button>
